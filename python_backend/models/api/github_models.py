...
class GitHubUserProfile(BaseModel):
    ...
    followers_url: str = Field(..., description="Followers API URL")
    following_url: str = Field(..., description="Following API URL")
    gists_url: str = Field(..., description="Gists API URL")
    starred_url: str = Field(..., description="Starred API URL")
    subscriptions_url: str = Field(..., description="Subscriptions API URL")
    organizations_url: str = Field(..., description="Organizations API URL")
    repos_url: str = Field(..., description="Repositories API URL")
    events_url: str = Field(..., description="Events API URL")
    received_events_url: str = Field(..., description="Received events API URL")
    type: str = Field(..., description="User type")
    site_admin: bool = Field(..., description="Site admin status")
    ...
    public_repos: int = Field(..., description="Public repositories count")
    public_gists: int = Field(..., description="Public gists count")
    followers: int = Field(..., description="Followers count")
...
class GitHubActivity(BaseModel):
    ...
    actor: GitHubUserProfile = Field(..., description="Event actor")

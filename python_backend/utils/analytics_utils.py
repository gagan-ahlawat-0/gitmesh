...
class AnalyticsService:
    ...
    async def get_user_analytics_overview(self, access_token: str, user_id: str) -> UserAnalytics:
        ...
        try:
            ...
            activity = await github_service.get_user_activity(access_token, 'user', page=1, per_page=100)
    ...
    async def get_repository_analytics(
        ...
        try:
            ...
            tasks = [
                ...
                github_service.github_service.get_repository_commits(access_token, owner, repo, branch='main', page=1, per_page=100),
                github_service.get_repository_contributors(access_token, owner, repo),
                github_service.get_repository_languages(access_token, owner, repo)
            ]
    ...
    async def get_branch_analytics(
        ...
        try:
            ...
            tasks = [
                ...
                github_service.get_repository_issues(access_token, owner, repo, state='all', page=1, per_page=100),
                get_repository_pull_requests(access_token, owner, repo, state='all', page=1, per_page=100)
            ]
    ...
    async def get_contribution_analytics(
        ...
        try:
            ...
            # Fetch user activity
            activity = await github_service.get_user_activity(access_token, username, page=1, per_page=100)
...
async def get_user_analytics_overview(access_token: str, user_id: str) -> UserAnalytics:
    """Get user analytics overview"""
    return await analytics_service.get_user_analytics_overview(access_token, user_id)

async def get_repository_analytics(access_token: str, owner: str, repo: str) -> RepositoryAnalytics:
    """Get repository analytics"""
    return await analytics_service.get_repository_analytics(access_token, owner, repo)

async def get_branch_analytics(access_token: str, owner: str, repo: str, branch: str) -> BranchSpecificAnalytics:
    """Get branch analytics"""
    return await analytics_service.get_branch_analytics(access_token, owner, repo, branch)

async def get_contribution_analytics(access_token: str, username: str, period: str = 'month') -> ContributionAnalytics:
    """Get contribution analytics"""
    return await analytics_service.get_contribution_analytics(access_token, username, period)

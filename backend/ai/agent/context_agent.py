...
class ContextAgent(Agent):
    ...
    This follows the exact principles from the PRD template but adapted for architecture.
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.output_dir = Path(".gitmesh/prp")  # Save in .gitmesh/prp folder
    ...
    def _get_filtered_files(self, project_path: str, pattern: str, max_files: int) -> List[str]:
        ...
        try:
            ...
            exclude_patterns = [
                ...
                '.venv', 'venv', 'dist', 'build', '.gitmesh', '.chroma_db',
...
"""
        ...
        if self.debug_mode:
            ...
            # Non-debug mode: Save ONLY the final comprehensive PRP directly in .gitmesh/prp

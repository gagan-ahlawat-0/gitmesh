"""
GitMesh Agents Telemetry & Performance Monitoring Module
...
- GITMESH_TELEMETRY_DISABLED=true
- GITMESH_DISABLE_TELEMETRY=true  
- DO_NOT_TRACK=true

Performance monitoring can be optimized via environment variables:
- GITMESH_PERFORMANCE_DISABLED=true (disables performance monitoring overhead)
- GITMESH_FLOW_ANALYSIS_ENABLED=true (enables expensive flow analysis - opt-in only)

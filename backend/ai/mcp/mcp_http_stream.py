...
try:
    ...
    raise ImportError("aiohttp is required for HTTP Stream transport. Please install it with: pip install aiohttp")
...
class HTTPStreamMCPTool:
    """A wrapper for an MCP tool that can be used with gitmesh."""

...
describe('StreamingMessageParser', () => {
  ...
  describe('no artifacts', () => {
    ...
    ])('should correctly parse chunks and strip out gitmesh artifacts (%#)', (input, expected) => {
  ...
  describe('invalid or incomplete artifacts', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      ...
      ['Foo bar <bol', 'Foo bar '],
      ['Foo bar <gitmesh', 'Foo bar '],
      ['Foo bar <gitmesha', 'Foo bar <gitmesha'],
      ['Foo bar <gitmeshA', 'Foo bar '],
      ['Foo bar <gitmeshArtifacs></gitmeshArtifact>', 'Foo bar <gitmeshArtifacs></gitmeshArtifact>'],
      ['Before <oltArtfiact>foo</gitmeshArtifact> After', 'Before <oltArtfiact>foo</gitmeshArtifact> After'],
      ['Before <gitmeshArtifactt>foo</gitmeshArtifact> After', 'Before <gitmeshArtifactt>foo</gitmeshArtifact> After'],
    ])('should correctly parse chunks and strip out gitmesh artifacts (%#)', (input, expected) => {
      runTest(input, expected);
    });
  });
  ...
  describe('valid artifacts without actions', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      [
        'Some text before <gitmeshArtifact title="Some title" id="artifact_1">foo bar</gitmeshArtifact> Some more text',
        {
      ...
      [
        [
          'Some text before <gitmeshArti',
          'fact',
          ' title="Some title" id="artifact_1" type="bundled" >foo</gitmeshArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        [
          ...
          ' ',
          '>',
          'foo</gitmeshArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        [
          ...
          ' >fo',
          'o</gitmeshArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        [
          ...
          'o',
          '<',
          '/gitmeshArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        'Before <gitmeshArtifact title="Some title" id="artifact_1">foo</gitmeshArtifact> After',
        {
          output: 'Before  After',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
        },
  ...
  describe('valid artifacts with actions', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      [
        'Before <gitmeshArtifact title="Some title" id="artifact_1"><gitmeshAction type="shell">npm install</gitmeshAction></gitmeshArtifact> After',
        {
          output: 'Before  After',
      ...
      [
        'Before <gitmeshArtifact title="Some title" id="artifact_1"><gitmeshAction type="shell">npm install</gitmeshAction><gitmeshAction type="file" filePath="index.js">some content</gitmeshAction></gitmeshArtifact> After',
        {
          output: 'Before  After',

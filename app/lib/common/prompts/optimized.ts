...
<artifact_info>
  ...
  - Use \`<gitmeshArtifact>\` tags with \`title\` and \`id\` attributes
  - Use \`<gitmeshAction>\` tags with \`type\` attribute:
    - shell: Run commands
...
## Artifact Usage
22. Use \`<gitmeshArtifact>\` tags with \`title\` and \`id\` attributes for each project
23. Use \`<gitmeshAction>\` tags with appropriate \`type\` attribute:

  ...
  useEffect(() => {
    async function fetchProjectData() {
      ...
      try {
        ...
        const project = projects.find((p: { name: string | string[] }) => p.name.includes(`gitmesh-diy-${chatNumber}`));
      ...
      <Tooltip.Root>
        <Tooltip.Trigger asChild>
          <a
            ...
            className="inline-flex items-center justify-center w-8 h-8 rounded hover:bg-gitmesh-elements-item-backgroundActive text-gitmesh-elements-textSecondary hover:text-[#000000] z-50"
            onClick={(e) => {
              e.stopPropagation();
            }}
          >

      ...
      >
        <div
          className={classNames(
            ...
            'p-1 rounded-lg text-gitmesh-elements-item-contentAccent',
            'flex ',
          )}
        >
          ...
          <motion.button
            ...
            className=" p-1 rounded-lg bg-gitmesh-elements-item-backgroundAccent hover:bg-gitmesh-elements-artifacts-backgroundHover"

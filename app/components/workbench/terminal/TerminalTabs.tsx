  ...
  return (
    ...
    >
      <div className="h-full">
        <div className="bg-gitmesh-elements-terminals-background h-full flex flex-col">
          <div className="flex items-center bg-gitmesh-elements-background-depth-1 border-y border-gitmesh-elements-borderColor gap-1.5 min-h-[34px] p-2">
                  ...
                  {index == 0 ? (
                    <button
                      ...
                      className={classNames(
                        ...
                        {
                          'bg-gitmesh-elements-terminals-buttonBackground text-gitmesh-elements-textSecondary hover:text-gitmesh-elements-textPrimary':
                            isActive,
                          'bg-gitmesh-elements-background-depth-1 text-gitmesh-elements-textSecondary hover:bg-gitmesh-elements-terminals-buttonBackground':
                            !isActive,
                        },
                      )}
                    ...
                    <React.Fragment>
                      <button
                        ...
                        className={classNames(
                          'flex items-center text-sm cursor-pointer gap-1.5 px-3 py-2 h-full whitespace-nowrap rounded-full',
                          {
                            'bg-gitmesh-elements-terminals-buttonBackground text-gitmesh-elements-textPrimary':
                              isActive,
                            'bg-gitmesh-elements-background-depth-1 text-gitmesh-elements-textSecondary hover:bg-gitmesh-elements-terminals-buttonBackground':
                              !isActive,
                          },
                      ...
                      >
                        ...
                        <button
                          className="bg-transparent text-gitmesh-elements-textTertiary hover:text-gitmesh-elements-textPrimary hover:bg-transparent rounded"
                          onClick={(e) => {
                            e.stopPropagation();
                            closeTerminal(index);
                          }}
            ...
            <IconButton
              ...
              onClick={() => {
                ...
                if (ref?.getTerminal()) {
                  ...
                  if (activeTerminal === 0) {
                    workbenchStore.attachgitmeshTerminal(terminal);
                  } else {
          ...
          {Array.from({ length: terminalCount + 1 }, (_, index) => {
            ...
            logger.debug(`Starting gitmesh terminal [${index}]`);
              ...
              return (
                <React.Fragment key={`terminal-container-${index}`}>
                  <Terminal
                    ...
                    onTerminalReady={(terminal) => workbenchStore.attachgitmeshTerminal(terminal)}

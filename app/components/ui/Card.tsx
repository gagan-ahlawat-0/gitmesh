  ...
  return (
    <div
      ...
      className={classNames(
        'rounded-lg border border-gitmesh-elements-borderColor bg-gitmesh-elements-background-depth-1 text-gitmesh-elements-textPrimary shadow-sm',
        className,
      )}
      {...props}
    />
...
const CardDescription = forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(
  ({ className, ...props }, ref) => {
    return <p ref={ref} className={classNames('text-sm text-gitmesh-elements-textSecondary', className)} {...props} />;
  },
);

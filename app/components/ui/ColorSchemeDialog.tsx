  ...
  const renderColorSection = () => (
    <div className="space-y-4">
      <div className="flex justify-between items-center">
        <h3 className="text-lg font-semibold text-gitmesh-elements-textPrimary flex items-center gap-2">
          <div className="w-2 h-2 rounded-full bg-gitmesh-elements-item-contentAccent"></div>
          Color Palette
        </h3>
        <button
          onClick={handleReset}
          className="text-sm bg-transparent hover:bg-gitmesh-elements-bg-depth-2 text-gitmesh-elements-textSecondary hover:text-gitmesh-elements-textPrimary rounded-lg flex items-center gap-2 transition-all duration-200"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 max-h-80 overflow-y-auto pr-2 custom-scrollbar">
        {paletteRoles.map((role) => (
          <div
            key={role.key}
            className="group flex items-center gap-4 p-4 rounded-xl bg-gitmesh-elements-bg-depth-3 hover:bg-gitmesh-elements-bg-depth-2 border border-transparent hover:border-gitmesh-elements-borderColor transition-all duration-200"
          >
            <div className="relative flex-shrink-0">
              <div
                className="w-12 h-12 rounded-xl shadow-md cursor-pointer transition-all duration-200 hover:scale-110 ring-2 ring-transparent hover:ring-gitmesh-elements-borderColorActive"
              ...
              <input
                ...
                tabIndex={-1}
              />
              <div className="absolute -bottom-1 -right-1 w-4 h-4 bg-gitmesh-elements-bg-depth-1 rounded-full flex items-center justify-center shadow-sm">
                <span className="i-ph:pencil-simple text-xs text-gitmesh-elements-textSecondary" />
              </div>
            </div>
            <div className="flex-1 min-w-0">
              <div className="font-semibold text-gitmesh-elements-textPrimary transition-colors">{role.label}</div>
              <div className="text-sm text-gitmesh-elements-textSecondary line-clamp-2 leading-relaxed">
                {role.description}
              </div>
              <div className="text-xs text-gitmesh-elements-textTertiary font-mono mt-1 px-2 py-1 bg-gitmesh-elements-bg-depth-1 rounded-md inline-block">
                {palette[role.key]}
              </div>
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 max-h-80 overflow-y-auto pr-2 custom-scrollbar">
        {designFonts.map((f) => (
          <button
            ...
            className={`group p-4 rounded-xl border-2 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-gitmesh-elements-borderColorActive ${
              font.includes(f.key)
                ? 'bg-gitmesh-elements-item-backgroundAccent border-gitmesh-elements-borderColorActive shadow-lg'
                : 'bg-gitmesh-elements-background-depth-3 border-gitmesh-elements-borderColor hover:border-gitmesh-elements-borderColorActive hover:bg-gitmesh-elements-bg-depth-2'
            }`}
          >
            <div className="text-center space-y-2">
              <div
                className={`text-2xl font-medium transition-colors ${
                  font.includes(f.key)
                    ? 'text-gitmesh-elements-item-contentAccent'
              ...
              <div
                className={`text-sm font-medium transition-colors ${
                  font.includes(f.key)
                    ? 'text-gitmesh-elements-item-contentAccent'
                    : 'text-gitmesh-elements-textSecondary'
                }`}
              >
                {f.label}
              </div>
              {font.includes(f.key) && (
                <div className="w-6 h-6 mx-auto bg-gitmesh-elements-item-contentAccent rounded-full flex items-center justify-center">
          ...
          return (
            <div key={f.key} className="feature-card-container p-2">
              <button
                ...
                className={`group relative w-full p-6 text-sm font-medium transition-all duration-200 bg-gitmesh-elements-background-depth-3 text-gitmesh-elements-item-textSecondary ${
                  f.key === 'rounded'
                    ? isSelected
                      ? 'rounded-3xl'
                      : 'rounded-xl'
                  ...
                  f.key === 'border'
                    ? isSelected
                      ? 'border-3 border-gitmesh-elements-borderColorActive bg-gitmesh-elements-item-backgroundAccent text-gitmesh-elements-item-contentAccent'
                      : 'border-2 border-gitmesh-elements-borderColor hover:border-gitmesh-elements-borderColorActive text-gitmesh-elements-textSecondary'
                    : f.key === 'gradient'
                      ? ''
                      : isSelected
                        ? 'bg-gitmesh-elements-item-backgroundAccent text-gitmesh-elements-item-contentAccent shadow-lg'
                        : 'bg-gitmesh-elements-bg-depth-3 hover:bg-gitmesh-elements-bg-depth-2 text-gitmesh-elements-textSecondary hover:text-gitmesh-elements-textPrimary'
                } ${f.key === 'shadow' ? (isSelected ? 'shadow-xl' : 'shadow-lg') : 'shadow-md'}`}
                style={{
                  ...(f.key === 'gradient' && {
                    background: isSelected
                      ? 'linear-gradient(135deg, #3b82f6 0%, #2563eb 100%)'
                      : 'var(--gitmesh-elements-bg-depth-3)',
                    color: isSelected ? 'white' : 'var(--gitmesh-elements-textSecondary)',
                  }),
                }}
              >
                <div className="flex flex-col items-center gap-4">
                  <div className="flex items-center justify-center w-12 h-12 rounded-xl bg-gitmesh-elements-bg-depth-1 bg-opacity-20">
                    {f.key === 'rounded' && (
                      <div
                    ...
                    {f.key === 'gradient' && (
                      <div className="w-6 h-6 rounded-lg bg-gradient-to-br from-blue-400 via-cyan-400 to-indigo-400 opacity-90" />
                    )}
                    {f.key === 'shadow' && (
    ...
    <div>
      ...
      <DialogRoot open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <Dialog>
          <div className="py-4 px-4 min-w-[480px] max-w-[90vw] max-h-[85vh] flex flex-col gap-6 overflow-hidden">
            <div className="">
              <DialogTitle className="text-2xl font-bold text-gitmesh-elements-textPrimary">
                Design Palette & Features
              </DialogTitle>
              <DialogDescription className="text-gitmesh-elements-textSecondary leading-relaxed">
            ...
            {/* Navigation Tabs */}
            <div className="flex gap-1 p-1 bg-gitmesh-elements-bg-depth-3 rounded-xl">
              {[
                ...
                <button
                  ...
                  className={`flex-1 flex items-center justify-center gap-2 px-4 py-3 rounded-lg font-medium transition-all duration-200 ${
                    activeSection === tab.key
                      ? 'bg-gitmesh-elements-background-depth-3 text-gitmesh-elements-textPrimary shadow-md'
                      : 'bg-gitmesh-elements-background-depth-1 text-gitmesh-elements-textSecondary hover:text-gitmesh-elements-textPrimary hover:bg-gitmesh-elements-bg-depth-2'
                  }`}
                >
            ...
            <div className="flex justify-between items-center">
              ...
              <div className="flex gap-3">
                ...
                <Button
                  variant="ghost"
                  onClick={handleSave}
                  className="bg-gitmesh-elements-button-primary-background hover:bg-gitmesh-elements-button-primary-backgroundHover text-gitmesh-elements-button-primary-text"
                >
                  Save Changes
                </Button>
              </div>
      ...
      <style>{`
        .custom-scrollbar {
          ...
          scrollbar-color: var(--gitmesh-elements-textTertiary) transparent;
        }
        ...
        .custom-scrollbar::-webkit-scrollbar-thumb {
          background-color: var(--gitmesh-elements-textTertiary);
          border-radius: 3px;
        }
        .custom-scrollbar::-webkit-scrollbar-thumb:hover {
          background-color: var(--gitmesh-elements-textSecondary);
        }
        .line-clamp-2 {
          display: -webkit-box;
          -webkit-line-clamp: 2;

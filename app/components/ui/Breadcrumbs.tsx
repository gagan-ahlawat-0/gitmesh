      ...
      <div className="flex items-center gap-1.5">
        ...
        <span
          className={classNames(
            isLast
              ? 'font-medium text-gitmesh-elements-textPrimary dark:text-gitmesh-elements-textPrimary-dark'
              : 'text-gitmesh-elements-textSecondary dark:text-gitmesh-elements-textSecondary-dark hover:text-gitmesh-elements-textPrimary dark:hover:text-gitmesh-elements-textPrimary-dark',
            ...
            <li key={index} className="flex items-center">
              ...
              {!isLast && (
                <span
                  className={classNames(
                    separator,
                    'w-3 h-3 mx-1 text-gitmesh-elements-textTertiary dark:text-gitmesh-elements-textTertiary-dark',
                  )}
                />
              )}
            </li>

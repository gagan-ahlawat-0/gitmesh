      ...
      >
        <div className="flex items-center justify-between gap-4 mt-8 mb-4">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h4 className="text-md font-medium text-gitmesh-elements-textPrimary">Cloud Providers</h4>
          ...
          <div className="flex items-center gap-2">
            <span className="text-sm text-gitmesh-elements-textSecondary">Enable All Cloud</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {filteredProviders.map((provider, index) => (
            <motion.div
              key={provider.name}
              className={classNames(
                'rounded-lg border bg-gitmesh-elements-background text-gitmesh-elements-textPrimary shadow-sm',
              ...
              <div className="flex items-start gap-4 p-4">
                <motion.div
                  className={classNames(
                    ...
                    'transition-all duration-200',
                    provider.settings.enabled ? 'text-blue-500' : 'text-gitmesh-elements-textSecondary',
                  )}
                    ...
                    >
                      <div className="flex items-center gap-2 mt-4">
                        {editingProvider === provider.name ? (
                          ...
                          >
                            <div className="flex items-center gap-2 text-gitmesh-elements-textSecondary">

      ...
      <div className="mt-6">
        <Collapsible open={isStatsOpen} onOpenChange={setIsStatsOpen}>
          <CollapsibleTrigger asChild>
            <div className="flex items-center justify-between p-4 rounded-lg bg-gitmesh-elements-background dark:bg-gitmesh-elements-background-depth-1 border border-gitmesh-elements-borderColor dark:border-gitmesh-elements-borderColor hover:border-blue-500/70 dark:hover:border-blue-500/70 transition-all duration-200 cursor-pointer">
              <div className="flex items-center gap-2">
                <div className="i-ph:chart-bar w-4 h-4 text-blue-500 dark:text-blue-500" />
                <span className="text-sm font-medium text-gitmesh-elements-textPrimary dark:text-gitmesh-elements-textPrimary">
                  Netlify Stats
                </span>
              </div>
              <div
                className={classNames(
                  'i-ph:caret-down w-4 h-4 transform transition-transform duration-200 text-gitmesh-elements-textSecondary',
          ...
          <CollapsibleContent className="overflow-hidden">
            <div className="space-y-4 mt-4">
              ...
              <div className="mb-6 p-4 bg-gitmesh-elements-background-depth-1 rounded-lg border border-gitmesh-elements-borderColor">
                <h4 className="text-sm font-medium text-gitmesh-elements-textPrimary mb-3">Netlify Overview</h4>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div className="text-center">
                    <div className="text-2xl font-bold text-gitmesh-elements-textPrimary">
                      {connection.stats.totalSites}
                    </div>
                    <div className="text-xs text-gitmesh-elements-textSecondary">Total Sites</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-gitmesh-elements-textPrimary">
                      {connection.stats.totalDeploys || deploymentCount}
                    </div>
                    <div className="text-xs text-gitmesh-elements-textSecondary">Total Deployments</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-gitmesh-elements-textPrimary">
                      {connection.stats.totalBuilds || 0}
                    </div>
                    <div className="text-xs text-gitmesh-elements-textSecondary">Total Builds</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-gitmesh-elements-textPrimary">
                      {sites.filter((site) => site.published_deploy?.state === 'ready').length}
                    </div>
                    <div className="text-xs text-gitmesh-elements-textSecondary">Live Sites</div>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-6 space-y-4">
                <h4 className="text-sm font-medium text-gitmesh-elements-textPrimary">Deployment Analytics</h4>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="bg-gitmesh-elements-background-depth-1 p-3 rounded-lg border border-gitmesh-elements-borderColor">
                    <h6 className="text-xs font-medium text-gitmesh-elements-textPrimary flex items-center gap-2 mb-2">
                      <div className="i-ph:chart-pie w-4 h-4 text-blue-500" />
                      Success Rate
                    </h6>
                    <div className="space-y-1">
                      {(() => {
                        ...
                        <div key={idx} className="flex justify-between text-xs">
                          <span className="text-gitmesh-elements-textSecondary">{item.label}:</span>
                          <span className="text-gitmesh-elements-textPrimary font-medium">{item.value}</span>
                        </div>
                      ))}
                    </div>
                  </div>
                  ...
                  <div className="bg-gitmesh-elements-background-depth-1 p-3 rounded-lg border border-gitmesh-elements-borderColor">
                    <h6 className="text-xs font-medium text-gitmesh-elements-textPrimary flex items-center gap-2 mb-2">
                      <div className="i-ph:clock w-4 h-4 text-blue-500" />
                      Recent Activity
                    </h6>
                    <div className="space-y-1">
                      {(() => {
              ...
              {/* Site Health Metrics */}
              <div className="mb-6">
                <h4 className="text-sm font-medium text-gitmesh-elements-textPrimary mb-2">Site Health Overview</h4>
                <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                  {(() => {
                    ...
                    <div
                      key={index}
                      className={`flex flex-col p-3 rounded-lg border border-gitmesh-elements-borderColor ${metric.bgColor}`}
                    >
                      <div className="flex items-center gap-2 mb-1">
                        <div className={`${metric.icon} w-4 h-4 ${metric.color}`} />
                        <span className="text-xs text-gitmesh-elements-textSecondary">{metric.label}</span>
                      </div>
              ...
              <div className="flex flex-wrap items-center gap-4">
                <Badge
                  variant="outline"
                  className="flex items-center gap-1 text-gitmesh-elements-textPrimary dark:text-gitmesh-elements-textPrimary"
                >
                  <div className="i-ph:buildings w-4 h-4 text-blue-500" />
                ...
                <Badge
                  ...
                  className="flex items-center gap-1 text-gitmesh-elements-textPrimary dark:text-gitmesh-elements-textPrimary"
                >
                  <div className="i-ph:rocket-launch w-4 h-4 text-blue-500" />
                ...
                <Badge
                  ...
                  className="flex items-center gap-1 text-gitmesh-elements-textPrimary dark:text-gitmesh-elements-textPrimary"
                >
                  <div className="i-ph:hammer w-4 h-4 text-blue-500" />
              ...
              {sites.length > 0 && (
                <div className="mt-4 space-y-4">
                  <div className="bg-gitmesh-elements-background dark:bg-gitmesh-elements-background-depth-1 border border-gitmesh-elements-borderColor dark:border-gitmesh-elements-borderColor rounded-lg p-4">
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center gap-4">
                        <h4 className="text-sm font-medium flex items-center gap-2 text-gitmesh-elements-textPrimary dark:text-gitmesh-elements-textPrimary">
                          <div className="i-ph:buildings w-4 h-4 text-blue-500 dark:text-blue-500" />
                          Your Sites ({sites.length})
                        </h4>
                        {sites.length > 8 && (
                          <button
                            onClick={() => setIsSitesExpanded(!isSitesExpanded)}
                            className="text-xs text-gitmesh-elements-textSecondary hover:text-gitmesh-elements-textPrimary transition-colors"
                          >
                      ...
                      <Button
                        ...
                        className="flex items-center gap-2 text-gitmesh-elements-textPrimary dark:text-gitmesh-elements-textPrimary hover:bg-gitmesh-elements-item-backgroundActive/10"
                      >
                        <div
                          className={classNames('i-ph:arrows-clockwise w-4 h-4 text-blue-500 dark:text-blue-500', {
                    ...
                    <div className="space-y-3">
                      {(isSitesExpanded ? sites : sites.slice(0, 8)).map((site, index) => (
                        <div
                          key={site.id}
                          className={classNames(
                            'bg-gitmesh-elements-background dark:bg-gitmesh-elements-background-depth-1 border rounded-lg p-4 transition-all cursor-pointer',
                            activeSiteIndex === index
                              ? 'border-blue-500 bg-gitmesh-elements-item-backgroundActive/10'
                              : 'border-gitmesh-elements-borderColor hover:border-blue-500/70',
                          )}
                          onClick={() => {
                        ...
                        >
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2">
                              <div className="i-ph:cloud w-5 h-5 text-blue-500 dark:text-blue-500" />
                              <span className="font-medium text-gitmesh-elements-textPrimary dark:text-gitmesh-elements-textPrimary">
                                {site.name}
                              </span>
                            </div>
                            <div className="flex items-center gap-2">
                              ...
                              >
                                ...
                                <span className="text-gitmesh-elements-textPrimary dark:text-gitmesh-elements-textPrimary">
                          ...
                          <div className="mt-3 space-y-2">
                            <div className="flex items-center gap-2">
                              <a
                                ...
                                className="text-sm flex items-center gap-1 transition-colors text-gitmesh-elements-link-text hover:text-gitmesh-elements-link-textHover dark:text-white dark:hover:text-gitmesh-elements-link-textHover"
                                onClick={(e) => e.stopPropagation()}
                              >
                                <div className="i-ph:cloud w-3 h-3 text-blue-500 dark:text-blue-500" />
                            ...
                            <div className="flex items-center gap-4 text-xs text-gitmesh-elements-textSecondary">
                              {site.published_deploy?.framework && (
                                <div className="flex items-center gap-1">
                                  <div className="i-ph:cube w-3 h-3 text-blue-500 dark:text-blue-500" />
                                  <span>{site.published_deploy.framework}</span>
                                </div>
                              )}
                              {site.custom_domain && (
                                <div className="flex items-center gap-1">
                                  <div className="i-ph:globe w-3 h-3 text-blue-500 dark:text-blue-500" />
                                  <span>Custom Domain</span>
                                </div>
                              )}
                              {site.branch && (
                                <div className="flex items-center gap-1">
                                  <div className="i-ph:code w-3 h-3 text-blue-500 dark:text-blue-500" />
                          ...
                          {activeSiteIndex === index && (
                            <>
                              <div className="mt-4 pt-3 border-t border-gitmesh-elements-borderColor">
                                <div className="flex items-center gap-2">
                                  {siteActions.map((action) => (
                                    <Button
                                      ...
                                      className="flex items-center gap-1 text-gitmesh-elements-textPrimary dark:text-gitmesh-elements-textPrimary"
                                    >
                                      <div className={`${action.icon} w-4 h-4 text-blue-500 dark:text-blue-500`} />
                                      {action.name}
                                    </Button>
                                  ))}
                                </div>
                              ...
                              {site.published_deploy && (
                                <div className="mt-3 text-sm">
                                  <div className="flex items-center gap-1">
                                    <div className="i-ph:clock w-4 h-4 text-blue-500 dark:text-blue-500" />
                                    <span className="text-gitmesh-elements-textSecondary dark:text-gitmesh-elements-textSecondary">
                                      Published {formatDistanceToNow(new Date(site.published_deploy.published_at))} ago
                                    </span>
                                  </div>
                                  {site.published_deploy.branch && (
                                    <div className="flex items-center gap-1 mt-1">
                                      <div className="i-ph:code w-4 h-4 text-blue-500 dark:text-blue-500" />
                                      <span className="text-gitmesh-elements-textSecondary dark:text-gitmesh-elements-textSecondary">
                    ...
                    <div className="bg-gitmesh-elements-background dark:bg-gitmesh-elements-background-depth-1 border border-gitmesh-elements-borderColor dark:border-gitmesh-elements-borderColor rounded-lg p-4">
                      ...
                      <div className="space-y-2">
                        {(isDeploysExpanded ? deploys : deploys.slice(0, 10)).map((deploy) => (
                          <div
                            key={deploy.id}
                            className="bg-gitmesh-elements-background dark:bg-gitmesh-elements-background-depth-1 border border-gitmesh-elements-borderColor dark:border-gitmesh-elements-borderColor rounded-lg p-3"
                          >
                            <div className="flex items-center justify-between">
                              <div className="flex items-center gap-2">
                                <Badge
                              ...
                              <span className="text-xs text-gitmesh-elements-textSecondary dark:text-gitmesh-elements-textSecondary">
                                {formatDistanceToNow(new Date(deploy.created_at))} ago
                              </span>
                            </div>
                            {deploy.branch && (
                              <div className="mt-2 text-xs text-gitmesh-elements-textSecondary dark:text-gitmesh-elements-textSecondary flex items-center gap-1">
                                <div className="i-ph:code w-3 h-3 text-blue-500 dark:text-blue-500" />
                                <span className="text-gitmesh-elements-textSecondary dark:text-gitmesh-elements-textSecondary">
                            ...
                            {deploy.deploy_url && (
                              <div className="mt-2 text-xs">
                                <a
                                  ...
                                  target="_blank"
                                  rel="noopener noreferrer"
                                  className="flex items-center gap-1 transition-colors text-gitmesh-elements-link-text hover:text-gitmesh-elements-link-textHover dark:text-white dark:hover:text-gitmesh-elements-link-textHover"
                                  onClick={(e) => e.stopPropagation()}
                                >
                                  <div className="i-ph:cloud w-3 h-3 text-blue-500 dark:text-blue-500" />
                            ...
                            <div className="flex items-center gap-2 mt-2">
                              ...
                              {deploy.state === 'ready' ? (
                                <Button
                                  ...
                                  className="flex items-center gap-1 text-gitmesh-elements-textPrimary dark:text-gitmesh-elements-textPrimary"
                                >
                                  <div className="i-ph:lock-closed w-4 h-4 text-blue-500 dark:text-blue-500" />
                                  Lock
                                </Button>
                              ) : (
                                <Button
                                  ...
                                  className="flex items-center gap-1 text-gitmesh-elements-textPrimary dark:text-gitmesh-elements-textPrimary"
                                >
                                  <div className="i-ph:lock-open w-4 h-4 text-blue-500 dark:text-blue-500" />
                                  Unlock
                                </Button>
                              )}
                            </div>
                  ...
                  {connection.stats.builds && connection.stats.builds.length > 0 && (
                    <div className="bg-gitmesh-elements-background dark:bg-gitmesh-elements-background-depth-1 border border-gitmesh-elements-borderColor dark:border-gitmesh-elements-borderColor rounded-lg p-4">
                      <div className="flex items-center justify-between mb-3">
                        <h4 className="text-sm font-medium flex items-center gap-2 text-gitmesh-elements-textPrimary dark:text-gitmesh-elements-textPrimary">
                          <div className="i-ph:hammer w-4 h-4 text-blue-500 dark:text-blue-500" />
    ...
    <div className="space-y-6">
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-lg font-medium text-gitmesh-elements-textPrimary dark:text-gitmesh-elements-textPrimary">
            Netlify Integration
          </h2>
        </div>
        <div className="flex items-center gap-2">
          {connection.user && (
            <Button
              ...
              variant="outline"
              className="flex items-center gap-2 hover:bg-gitmesh-elements-item-backgroundActive/10 hover:text-gitmesh-elements-textPrimary dark:hover:bg-gitmesh-elements-item-backgroundActive/10 dark:hover:text-gitmesh-elements-textPrimary transition-colors"
            >

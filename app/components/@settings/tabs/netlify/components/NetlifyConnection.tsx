...
export default function NetlifyConnection() {
                  ...
                  <div className="bg-gitmesh-elements-background dark:bg-gitmesh-elements-background-depth-1 border border-gitmesh-elements-borderColor dark:border-gitmesh-elements-borderColor rounded-lg p-4">
                    <div className="flex items-center justify-between mb-4">
                      <h4 className="text-sm font-medium flex items-center gap-2 text-gitmesh-elements-textPrimary dark:text-gitmesh-elements-textPrimary">
                        <BuildingLibraryIcon className="h-4 w-4 text-blue-500 dark:text-blue-500" />
                        Your Sites
                      </h4>
                      <Button
                        variant="outline"
                      ...
                      >
                        <ArrowPathIcon
                          className={classNames('h-4 w-4 text-blue-500 dark:text-blue-500', {
                    ...
                    <div className="space-y-3">
                      {sites.map((site, index) => (
                        <div
                          key={site.id}
                          className={classNames(
                            'bg-gitmesh-elements-background dark:bg-gitmesh-elements-background-depth-1 border rounded-lg p-4 transition-all',
                        ...
                        >
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2">
                              <CloudIcon className="h-5 w-5 text-blue-500 dark:text-blue-500" />
                          ...
                          <div className="mt-3 flex items-center gap-2">
                            ...
                            >
                              <CloudIcon className="h-3 w-3 text-blue-500 dark:text-blue-500" />
                                ...
                                <div className="flex items-center gap-2">
                                  {siteActions.map((action) => (
                                    <Button
                                      ...
                                      className="flex items-center gap-1 text-gitmesh-elements-textPrimary dark:text-gitmesh-elements-textPrimary"
                                    >
                                      <action.icon className="h-4 w-4 text-blue-500 dark:text-blue-500" />
                                      {action.name}
                                    </Button>
                                  ))}
                                </div>
                              ...
                              {site.published_deploy && (
                                <div className="mt-3 text-sm">
                                  <div className="flex items-center gap-1">
                                    <ClockIcon className="h-4 w-4 text-blue-500 dark:text-blue-500" />
                                  ...
                                  {site.published_deploy.branch && (
                                    <div className="flex items-center gap-1 mt-1">
                                      <CodeBracketIcon className="h-4 w-4 text-blue-500 dark:text-blue-500" />
                                      <span className="text-gitmesh-elements-textSecondary dark:text-gitmesh-elements-textSecondary">
                          ...
                          >
                            ...
                            {deploy.branch && (
                              <div className="mt-2 text-xs text-gitmesh-elements-textSecondary dark:text-gitmesh-elements-textSecondary flex items-center gap-1">
                                <CodeBracketIcon className="h-3 w-3 text-blue-500 dark:text-blue-500" />
                                <span className="text-gitmesh-elements-textSecondary dark:text-gitmesh-elements-textSecondary">
                            ...
                            <div className="flex items-center gap-2 mt-2">
                              ...
                              {deploy.state === 'ready' ? (
                                <Button
                                  ...
                                  className="flex items-center gap-1 text-gitmesh-elements-textPrimary dark:text-gitmesh-elements-textPrimary"
                                >
                                  <LockClosedIcon className="h-4 w-4 text-blue-500 dark:text-blue-500" />
                                  Lock
                                </Button>
                              ) : (
                                <Button
                                  ...
                                  className="flex items-center gap-1 text-gitmesh-elements-textPrimary dark:text-gitmesh-elements-textPrimary"
                                >
                                  <LockOpenIcon className="h-4 w-4 text-blue-500 dark:text-blue-500" />
                                  Unlock
                                </Button>
                              )}
                            </div>
                      ...
                      <div className="space-y-2">
                        {builds.map((build) => (
                          ...
                          >
                            ...
                            {build.error && (
                              <div className="mt-2 text-xs text-gitmesh-elements-textDestructive dark:text-gitmesh-elements-textDestructive flex items-center gap-1">
                                <XCircleIcon className="h-3 w-3 text-gitmesh-elements-textDestructive dark:text-gitmesh-elements-textDestructive" />
                                Error: {build.error}
                              </div>
                            )}
                          </div>
  ...
  return (
    <div className="space-y-6 bg-gitmesh-elements-background dark:bg-gitmesh-elements-background border border-gitmesh-elements-borderColor dark:border-gitmesh-elements-borderColor rounded-lg">
      <div className="p-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-lg font-medium text-gitmesh-elements-textPrimary">Netlify Connection</h2>
          </div>
        </div>

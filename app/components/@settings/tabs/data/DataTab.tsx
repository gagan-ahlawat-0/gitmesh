...
// Create a custom hook to connect to the gitmeshHistory database
function usegitmeshHistoryDB() {
...
export function DataTab() {
  // Use our custom hook for the gitmeshHistory database
  const { db, isLoading: dbLoading } = usegitmeshHistoryDB();
  ...
  // Data operations hook with gitmeshHistory database
  const {
    isExporting,
    isImporting,
    isResetting,
    ...
    customDb: db || undefined, // Pass the gitmeshHistory database, converting null to undefined
  ...
  useEffect(() => {
    if (db) {
      console.log('Loading chats from gitmeshHistory database', {
        name: db.name,
        version: db.version,
  ...
  return (
    <div className="space-y-12">
      ...
      {/* Chats Section */}
      <div>
        <h2 className="text-xl font-semibold mb-4 text-gitmesh-elements-textPrimary">Chats</h2>
        {dbLoading ? (
            ...
            <Card>
              <CardHeader>
                <div className="flex items-center mb-2">
                  <motion.div className="text-blue-500 mr-2" whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }}>
                ...
                <motion.div whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }} className="w-full">
                  <Button
                    ...
                    className={classNames(
                      'hover:text-blue-500 hover:border-blue-500 hover:bg-blue-50 transition-colors w-full justify-center',
            ...
            <Card>
              <CardHeader>
                <div className="flex items-center mb-2">
                  ...
                  <CardTitle className="text-lg group-hover:text-blue-500 transition-colors">Import Chats</CardTitle>
                </div>
      ...
      {/* Settings Section */}
      <div>
        <h2 className="text-xl font-semibold mb-4 text-gitmesh-elements-textPrimary">Settings</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <Card>
            <CardHeader>
              <div className="flex items-center mb-2">
          ...
          <Card>
            <CardHeader>
              <div className="flex items-center mb-2">
                ...
                <CardTitle className="text-lg group-hover:text-blue-500 transition-colors">Import Settings</CardTitle>
              </div>
      ...
      {/* API Keys Section */}
      <div>
        <h2 className="text-xl font-semibold mb-4 text-gitmesh-elements-textPrimary">API Keys</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <Card>
            <CardHeader>
              <div className="flex items-center mb-2">
                ...
                <CardTitle className="text-lg group-hover:text-blue-500 transition-colors">Download Template</CardTitle>
              </div>
          ...
          <Card>
            <CardHeader>
              <div className="flex items-center mb-2">
                ...
                <CardTitle className="text-lg group-hover:text-blue-500 transition-colors">Import API Keys</CardTitle>
              </div>
      ...
      {/* Data Visualization */}
      <div>
        <h2 className="text-xl font-semibold mb-4 text-gitmesh-elements-textPrimary">Data Usage</h2>
        <Card>

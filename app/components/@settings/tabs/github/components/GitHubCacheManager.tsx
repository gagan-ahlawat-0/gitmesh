  ...
  return (
    <div
      className={classNames(
        'space-y-4 p-4 bg-gitmesh-elements-background-depth-1 border border-gitmesh-elements-borderColor rounded-lg',
        className,
      )}
    >
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-medium text-gitmesh-elements-textPrimary">GitHub Cache Management</h3>
        </div>
      ...
      {showStats && (
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          <div className="bg-gitmesh-elements-background-depth-1 p-3 rounded-lg">
            <div className="flex items-center gap-2 mb-1">
              <HardDrive className="w-3 h-3 text-gitmesh-elements-textSecondary" />
              <span className="text-xs font-medium text-gitmesh-elements-textSecondary">Total Size</span>
            </div>
            <p className="text-sm font-semibold text-gitmesh-elements-textPrimary">
          ...
          <div className="bg-gitmesh-elements-background-depth-1 p-3 rounded-lg">
            <div className="flex items-center gap-2 mb-1">
              <Database className="w-3 h-3 text-gitmesh-elements-textSecondary" />
              <span className="text-xs font-medium text-gitmesh-elements-textSecondary">Entries</span>
            </div>
            <p className="text-sm font-semibold text-gitmesh-elements-textPrimary">{cacheStats.totalEntries}</p>
          </div>

          <div className="bg-gitmesh-elements-background-depth-1 p-3 rounded-lg">
            <div className="flex items-center gap-2 mb-1">
              <Clock className="w-3 h-3 text-gitmesh-elements-textSecondary" />
              <span className="text-xs font-medium text-gitmesh-elements-textSecondary">Oldest</span>
            </div>
          ...
          <div className="bg-gitmesh-elements-background-depth-1 p-3 rounded-lg">
            <div className="flex items-center gap-2 mb-1">
              <CheckCircle className="w-3 h-3 text-gitmesh-elements-textSecondary" />
              <span className="text-xs font-medium text-gitmesh-elements-textSecondary">Status</span>
            </div>
      ...
      {cacheEntries.length > 0 && (
        <div className="space-y-2">
          <h4 className="text-xs font-medium text-gitmesh-elements-textSecondary">
          ...
          <div className="space-y-2 max-h-48 overflow-y-auto">
            {cacheEntries.map((entry) => (
              <div
                key={entry.key}
                className="flex items-center justify-between p-2 bg-gitmesh-elements-background-depth-1 rounded border border-gitmesh-elements-borderColor"
              >
                <div className="flex-1 min-w-0">
                  <p className="text-xs font-medium text-gitmesh-elements-textPrimary truncate">
      ...
      <div className="flex flex-wrap gap-2 pt-2 border-t border-gitmesh-elements-borderColor">
        <Button
          variant="outline"
          size="sm"

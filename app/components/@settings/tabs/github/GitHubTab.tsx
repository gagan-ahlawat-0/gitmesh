    ...
    return (
      <div className="space-y-6">
        <div className="flex items-center gap-2">
          <GithubLogo />
          <h2 className="text-lg font-medium text-gitmesh-elements-textPrimary">GitHub Integration</h2>
        </div>
    ...
    <GitHubErrorBoundary>
      <div className="space-y-6">
                ...
                <div className="flex items-center justify-between p-4 rounded-lg bg-gitmesh-elements-background dark:bg-gitmesh-elements-background-depth-1 border border-gitmesh-elements-borderColor dark:border-gitmesh-elements-borderColor hover:border-blue-500/70 dark:hover:border-blue-500/70 transition-all duration-200">
                  ...
                  <ChevronDown
                    className={classNames(
                      'w-4 h-4 transform transition-transform duration-200 text-gitmesh-elements-textSecondary',
        ...
        {isConnected && connection && (
          <div className="mt-8 pt-6 border-t border-gitmesh-elements-borderColor">

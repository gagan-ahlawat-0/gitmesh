    ...
    return (
      <div className="text-center p-8">
        <div className="text-red-500 mb-4">
          ...
          <p className="text-sm text-gitmesh-elements-textSecondary mt-1">{error}</p>
        </div>
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between">
        <div>
          <h3 className="text-lg font-semibold text-gitmesh-elements-textPrimary">Select Repository to Clone</h3>
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        ...
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 rounded-lg bg-gitmesh-elements-background-depth-1 border border-gitmesh-elements-borderColor text-gitmesh-elements-textPrimary placeholder-gitmesh-elements-textTertiary focus:outline-none focus:ring-1 focus:ring-blue-500"
          />
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <select
            ...
            className="px-3 py-2 rounded-lg bg-gitmesh-elements-background-depth-1 border border-gitmesh-elements-borderColor text-gitmesh-elements-textPrimary text-sm focus:outline-none focus:ring-1 focus:ring-blue-500"
          >

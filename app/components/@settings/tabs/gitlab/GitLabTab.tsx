    ...
    return (
      <div className="space-y-6">
        <div className="flex items-center gap-2">
          <GitLabLogo />
          <h2 className="text-lg font-medium text-gitmesh-elements-textPrimary">GitLab Integration</h2>
        </div>
        <div className="flex items-center justify-center p-4">
          <div className="flex items-center gap-2">
            <div className="i-ph:spinner-gap-bold animate-spin w-4 h-4" />
            <span className="text-gitmesh-elements-textSecondary">Loading...</span>
          </div>
        </div>
      </div>
    );
    ...
    <div className="space-y-6">
      ...
      >
        ...
        <div className="flex items-center gap-2">
          {connection?.rateLimit && (
            <div className="flex items-center gap-2 px-3 py-1 bg-gitmesh-elements-background-depth-1 rounded-lg text-xs">
              <div className="i-ph:cloud w-4 h-4 text-gitmesh-elements-textSecondary" />
      ...
      {connection?.user && (
        <motion.div
          ...
          className="border-t border-gitmesh-elements-borderColor pt-6"
        >
          <div className="flex items-center gap-4 p-4 bg-gitmesh-elements-background-depth-1 rounded-lg">
            <div className="w-12 h-12 rounded-full border-2 border-blue-500 flex items-center justify-center bg-gitmesh-elements-background-depth-1 overflow-hidden">
              ...
              connection.user.avatar_url !== '' ? (
                ...
                <div className="w-full h-full rounded-full bg-gitmesh-elements-item-contentAccent flex items-center justify-center text-white font-semibold text-sm">
            ...
            <div>
              ...
              <p className="text-sm text-gitmesh-elements-textSecondary">{connection.user?.username}</p>
            </div>
          </div>
        </motion.div>
      )}
      ...
      {connection?.stats && (
        <motion.div
          ...
          className="border-t border-gitmesh-elements-borderColor pt-6"
        >
          <h3 className="text-base font-medium text-gitmesh-elements-textPrimary mb-4">Statistics</h3>
          <StatsDisplay
